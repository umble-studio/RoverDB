...
public sealed class RoverDatabase : Singleton<RoverDatabase>
{
	public bool IsInitialised => Initialization.CurrentDatabaseState is DatabaseState.Initialised;
	...
	/// </summary>
	public void CopySavedData<T>( T sourceClass, T destinationClass )
	{
	...
	public void Delete<T>( Predicate<T> selector ) where T : class
	{
		...
		foreach ( var id in idsToDelete )
		{
			...
			FileController.DeleteDocument( collectionAttr.Name, id );
		}
	}
